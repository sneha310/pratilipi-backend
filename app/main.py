...
app = Flask(__name__)
cors = CORS(app, resources={r"/api/*": {"origins": "https://read-count.vercel.app"}}, allow_headers=["Content-Type", "Authorization", "Access-Control-Allow-Credentials"], supports_credentials=True)
